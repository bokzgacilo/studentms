                    ...
                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                      ...
                      if ($query->rowCount() > 0) {
                        foreach ($results as $row) { ?>
                          ...
                          <div class="form-group">
                            <label for="exampleInputVerify">Verification Status</label>
                            <select name="verify" class="form-control" required='true'>
                              <option value="1" <?php if ($row->verify == 1)
                                echo 'selected'; ?>>Verified</option>
                              <option value="0" <?php if ($row->verify == 0)
                                echo 'selected'; ?>>Not Verified</option>
                            </select>
                          </div>
